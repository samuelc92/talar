defmodule TalarWeb.UserAuth do
  ...
  # If this value is changed, also change the token
  # expiry itself in UserToken.
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_talar_web_user_remember_me"
  ...
  to avoid fixation attacks. See the renew_sesion function
  ...
  def maybe_write_remember_me_cookie(conn, _token, _params), do: conn
  ...
  # you may want to preserve after log in/log out.
  # you must explicitly fetch the session data before clearing
  # and then immediately set it after clearing, for example:DSS
  #
